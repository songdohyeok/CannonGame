...
public class BoundedBallTest {
    ...
    public void testInitialBounds() {
        ...
        assertEquals(150, newCenter.x(), 0.001, "경계가 없을 때 X 이동이 제한되면 안됩니다");
        assertEquals(150, newCenter.y(), 0.001, "경계가 없을 때 Y 이동이 제한되면 안됩니다");
    }
    ...
    */
    ...
    public void testWallCollisionLeft() {
        ball.moveTo(new Point(10, ball.getCenter().y())); // 왼쪽 벽 근처
    ...
    public void testWallCollisionRight() {
        ball.moveTo(new Point(780, ball.getCenter().y())); // 오른쪽 벽 근처 (800 - 20)
    ...
    public void testWallCollisionTop() {
        ball.moveTo(new Point(ball.getCenter().x(), 10)); // 위쪽 벽 근처
    ...
    public void testWallCollisionBottom() {
        ball.moveTo(new Point(ball.getCenter().x(), 580)); // 아래쪽 벽 근처 (600 - 20)
    ...
    public void testInheritance() {
        ...
        assertEquals(oldCenter.x() + 10, newCenter.x(), 0.001, "상속받은 move 메서드가 작동하지 않습니다");
        assertEquals(oldCenter.y() + 7.5, newCenter.y(), 0.001, "상속받은 move 메서드가 작동하지 않습니다");
    }
}